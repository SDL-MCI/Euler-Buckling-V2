...
const float TEILERFAKTOR = 0.666;
...
const float ScaleFactor_2 = 10.9049; // Scale factor for the sensor 2
const float Offset_V_2 = 0.48; // Offset for the sensor 2 voltage

const float ScaleFactor_3 = 37.95; // Scale factor for the sensor 3
const float Offset_V_3 = 0.5; // Offset for the sensor 3 voltage
